...
export default function Hero() {
  return (
    <section className="bg-matcha-light min-h-[80vh] flex flex-col justify-center items-center text-center px-6">
      ...
      >
        Thoughtfully designed kitchen essentials that look as good as they perform.
      </motion.p>
      ...
      >
        <Link
          href="/shop"
          className="inline-block bg-matcha text-matcha-dark font-semibold py-4 px-10 rounded-full shadow-md hover:bg-matcha-dark hover:text-white transition-colors"
        >
          Shop the Collection
        </Link>
      </motion.div>
