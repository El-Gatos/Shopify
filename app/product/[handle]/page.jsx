...
export default async function ProductPage({ params }) {
  ...
  // Isolate the variant ID we just added to the GraphQL query
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 mt-10">
      <div className="relative h-[60vh] md:h-[80vh] w-full bg-matcha-light rounded-3xl overflow-hidden shadow-sm">
        ...
        {imageUrl ? <Image src={imageUrl} alt={title} fill className="object-contain p-8" /> : <div>No Image</div>}
      </div>
      ...
      <div className="flex flex-col justify-center">
        ...
        {/* Drop the real button in and pass it the data */}
