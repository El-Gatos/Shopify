    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 mt-10">
        <div className="relative h-[60vh] md:h-[80vh] w-full bg-matcha-light rounded-3xl overflow-hidden shadow-sm">
          {imageUrl ? (
            <Image src={imageUrl} alt={product.title} fill className="object-cover p-8" />
          ) : (
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight mb-4">{product.title}</h1>
          <p className="text-2xl text-matcha-dark font-medium mb-8">${price}</p>
          <div className="prose prose-matcha text-gray-600 mb-10 leading-relaxed" dangerouslySetInnerHTML={{ __html: product.descriptionHtml }} />
